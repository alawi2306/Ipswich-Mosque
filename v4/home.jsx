        ...
        <div className="hero-welcome">
          <div style={{ background: "white", border: "1px solid var(--line)", borderRadius: "var(--radius)", padding: "36px", boxShadow: "var(--shadow-md)", flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div className="welcome-links">
              {[
                { icon: Icon.Calendar, label: "Events & classes", route: "events", hideOnMobile: true },
                ...
                return (
                  <button key={i}
                    className={`welcome-link${q.hideOnMobile ? " welcome-events-hide" : ""}`}
                    onClick={() => window.__setRoute(q.route)}>
    ...
    <div className="container">
      ...
      <div key={i} className="timeline-item">
            ...
            <div className="timeline-body">
              <div className="timeline-date timeline-date-mobile">{t.date}</div>
  ...
  <div className="container">
    <div className="combined-cta-grid">
      <div className="combined-cta-share">
        ...
        <button className="btn btn-primary">Share with us <Icon.Arrow width="14" height="14" /></button>
      </div>
      ...
      <div className="combined-cta-newsletter">
        ...
        <form className="newsletter-form-v4" onSubmit={(e) => e.preventDefault()}>
          <input type="text" placeholder="Your name" />
          <input type="email" placeholder="Email address" />
          <button type="submit" className="btn btn-primary">Subscribe <Icon.Arrow width="14" height="14" /></button>
        </form>
        <a href="#" className="whatsapp-strip" style={{ marginTop: 14, display: "inline-flex" }}>
