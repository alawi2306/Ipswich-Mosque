  ...
  return (
    <div className="app" data-screen-label={`SMS · ${route}`}>
      ...
      <TweaksPanel title="Tweaks">
        ...
        <TweakSection title="Other versions">
          <div style={{display:"grid", gap: 4, fontSize: 13}}>
            <a href="../index.html" style={{padding: "7px 10px", border: "1px solid var(--line)", borderRadius: 6, color: "var(--ink-2)", fontWeight: 500}}>← v3 (timetable in navbar)</a>
            ...
            <div style={{padding: "7px 10px", background: "var(--teal-50)", border: "1px solid var(--teal-500)", color: "var(--teal-700)", borderRadius: 6, fontWeight: 600}}>v4 (classic nav + times on page) — current</div>
          </div>
        </TweakSection>
      </TweaksPanel>
    </div>
