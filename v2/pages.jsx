  ...
  return (
    <>
      <PageHeader
        ...
        sub="Begin times calculated by Muslim World League method. Iqamah times set by each masjid committee and updated weekly."
      />
            ...
            <div>
              ...
              <div className="pt-notes">
                ...
                <div className="pt-note">
                  ...
                  <p>Begin times follow MWL calculation. Iqamah times are decided by each masjid committee.</p>
                </div>
                <div className="pt-note">
